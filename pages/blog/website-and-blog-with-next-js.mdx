...
I like the framework for its very light footprint & because the Developer Experience is superb: very fast builds and an opiniated architecture. Additionally to its server-rendering capabilities, it also allows you to export a static site.

There are alternatives, of which [Gatsby](https://www.gatsbyjs.org) would be the most popular one. I thought about using it for my website, especially because they just released version 2. Ultimately, I fell far too much in love with Next.js's simplicity and stuck with it.

One of the most important integrations I use is [MDX](https://github.com/mdx-js/mdx), for which Next.js has a [plugin](https://github.com/zeit/next-plugins/tree/master/packages/next-mdx). With this, you can simply import any mdx file and use it as if it was a React component.
